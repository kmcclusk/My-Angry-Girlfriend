...
export default class SashaScreen extends Component {
  ...
  componentWillMount() {
    ...
    this.setState(() => {
      return {
        messages: require('../../Texting/data/sashaText.js'),
      };
    });
  }
...
AppRegistry.registerComponent('Sasha', ()=> SashaScreen);